...
public class DialogFactory {
    ...
    public AlertDialog showAlertDialog(Context ctx, int titleIcon, String title, String dialogMessage, String positiveButtonText, DialogInterface.OnClickListener onPositiveClickListener, boolean isCancellable) {
        return showAlertDialog(ctx, titleIcon, title, dialogMessage, positiveButtonText, onPositiveClickListener, null, null, isCancellable);
    }

    public AlertDialog showMultipleDialog(Context context, @Nullable int titleIcon, String title, String dialogMessage, String positiveButtonText, DialogInterface.OnClickListener dialogPositiveClickListener, @Nullable String negativeButtonText, @Nullable DialogInterface.OnClickListener dialogNegativeClickListener, boolean isCancellable) {
        AlertDialog alert;
        AlertDialog.Builder builder = new AlertDialog.Builder(context, R.style.DialogTheme);
        builder.setCancelable(isCancellable);
        builder.setInverseBackgroundForced(true);
    ...
    public Dialog showCustomDialog(Context context, int layoutId, boolean status) {
