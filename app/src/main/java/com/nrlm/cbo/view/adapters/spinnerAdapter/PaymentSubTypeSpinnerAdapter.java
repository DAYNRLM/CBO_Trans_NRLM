...
public class PaymentSubTypeSpinnerAdapter extends ArrayAdapter<MasterTransShgPaymentSubTypeEntity> {
    public PaymentSubTypeSpinnerAdapter(@NonNull Context context, @NonNull List<MasterTransShgPaymentSubTypeEntity> objects) {
    ...
    private View initView(int position, @Nullable View convertView,
        ...
        MasterTransShgPaymentSubTypeEntity currentItem = (MasterTransShgPaymentSubTypeEntity)getItem(position);

        // It is used the name to the TextView when the
        // current item is not null.
        if (currentItem != null) {
            textViewName.setText(""+currentItem.payment_sub_discription);
        }
        return convertView;
    }
