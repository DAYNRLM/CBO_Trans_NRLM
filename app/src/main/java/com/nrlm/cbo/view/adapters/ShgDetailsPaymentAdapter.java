...
import com.nrlm.cbo.view.Activities.ShgLoansPaymentActivity;
...
public class ShgDetailsPaymentAdapter extends RecyclerView.Adapter<ShgDetailsPaymentAdapter.ShgDetailsPaymentHolder>
    ...
    public ShgDetailsPaymentAdapter(Context context, List<ShgEntityDataModel> shgDetailsList){
    ...
    @NonNull
    @Override
    public ShgDetailsPaymentAdapter.ShgDetailsPaymentHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View selectShgListView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.reciepts_shg_details_item, parent, false);
        return new ShgDetailsPaymentAdapter.ShgDetailsPaymentHolder(selectShgListView);
    }

    @Override
    public void onBindViewHolder(@NonNull ShgDetailsPaymentAdapter.ShgDetailsPaymentHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AppUtils.getInstance().makeIntent(context, ShgLoansPaymentActivity.class,false);
            }
        });
    }
    ...
    public class ShgDetailsPaymentHolder extends RecyclerView.ViewHolder {
        ...
        public ShgDetailsPaymentHolder(@NonNull View itemView) {
            super(itemView);
