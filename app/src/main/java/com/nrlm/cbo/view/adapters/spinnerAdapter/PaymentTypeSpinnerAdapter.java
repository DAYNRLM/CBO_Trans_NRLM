...
public class PaymentTypeSpinnerAdapter extends ArrayAdapter<MasterTransShgPaymentEntity> {

    public PaymentTypeSpinnerAdapter(@NonNull Context context, @NonNull List<MasterTransShgPaymentEntity> objects) {
    ...
    private View initView(int position, @Nullable View convertView,
        ...
        MasterTransShgPaymentEntity currentItem = (MasterTransShgPaymentEntity)getItem(position);

        // It is used the name to the TextView when the
        // current item is not null.
        if (currentItem != null) {
            textViewName.setText(""+currentItem.payment_discription);
        }
        return convertView;
    }
